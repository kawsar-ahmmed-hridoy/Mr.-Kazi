...
import 'package:mr_kazi/Intro/Page2.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("View services 360 degrees", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),), Text("You can see the solution from all angles."),
            SizedBox(height: 50),
